...
//                    SECTION - 3
                    ...
                    GroupBox(
                        ...
                        SettingsRowView(name: "Designer", content: "samObi")
                        SettingsRowView(name: "Compatibility", content: "iOS 15")
                        SettingsRowView(name: "Website", linkLabel: "swiftProject", linkDestination: "clearview.click")
                        SettingsRowView(name: "Twitter", linkLabel: "@brainzcode", linkDestination: "twitter.com/brainzcode")
